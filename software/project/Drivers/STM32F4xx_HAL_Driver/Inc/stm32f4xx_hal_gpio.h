...
typedef struct {
    ...
    uint32_t Pull; /*!< Specifies the Pull-up or Pull-Down activation
                      for the selected pins. This parameter can be a
                      value of @ref GPIO_pull_define */
    ...
    uint32_t
        Alternate; /*!< Peripheral to be connected to the selected
                      pins. This parameter can be a value of @ref
 ...
 *           - Z  : GPIO mode (Input, Output, Alternate or Analog) on
 * 2 bits
 * @{
 */
...
#define GPIO_MODE_IT_RISING                                          \
    (MODE_INPUT | EXTI_IT |                                          \
     TRIGGER_RISING) /*!< External Interrupt Mode with Rising edge   \
                        trigger detection          */
#define GPIO_MODE_IT_FALLING                                         \
    (MODE_INPUT | EXTI_IT |                                          \
     TRIGGER_FALLING) /*!< External Interrupt Mode with Falling edge \
                         trigger detection         */
#define GPIO_MODE_IT_RISING_FALLING                                  \
    (MODE_INPUT | EXTI_IT | TRIGGER_RISING |                         \
     TRIGGER_FALLING) /*!< External Interrupt Mode with              \
                         Rising/Falling edge trigger detection  */

#define GPIO_MODE_EVT_RISING                                         \
    (MODE_INPUT | EXTI_EVT |                                         \
     TRIGGER_RISING) /*!< External Event Mode with Rising edge       \
                        trigger detection             */
#define GPIO_MODE_EVT_FALLING                                        \
    (MODE_INPUT | EXTI_EVT |                                         \
     TRIGGER_FALLING) /*!< External Event Mode with Falling edge     \
                         trigger detection            */
#define GPIO_MODE_EVT_RISING_FALLING                                 \
    (MODE_INPUT | EXTI_EVT | TRIGGER_RISING |                        \
     TRIGGER_FALLING) /*!< External Event Mode with Rising/Falling   \
...
#define GPIO_SPEED_FREQ_LOW                                          \
    0x00000000U /*!< IO works at 2 MHz, please refer to the product  \
                   datasheet */
#define GPIO_SPEED_FREQ_MEDIUM                                       \
    0x00000001U /*!< range 12,5 MHz to 50 MHz, please refer to the   \
                   product datasheet */
#define GPIO_SPEED_FREQ_HIGH                                         \
    0x00000002U /*!< range 25 MHz to 100 MHz, please refer to the    \
                   product datasheet  */
#define GPIO_SPEED_FREQ_VERY_HIGH                                    \
    0x00000003U /*!< range 50 MHz to 200 MHz, please refer to the    \
                   product datasheet  */
/**
 * @}
 */
 ...
 */
#define GPIO_NOPULL                                                  \
    0x00000000U /*!< No Pull-up or Pull-down activation  */
#define GPIO_PULLUP                                                  \
    0x00000001U /*!< Pull-up activation                  */
#define GPIO_PULLDOWN                                                \
    0x00000002U /*!< Pull-down activation                */
/**
 * @}
 */
 ...
 *         This parameter can be any combination of GPIO_PIN_x where x
 * can be (0..15)
 * @retval None
 */
