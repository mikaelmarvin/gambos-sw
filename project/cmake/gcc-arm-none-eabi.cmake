...
if(NOT EXISTS "${_BOARD_FILE}")
    message(FATAL_ERROR "Unknown BOARD '${BOARD}': missing ${_BOARD_FILE}")
endif()
include("${_BOARD_FILE}")

if(NOT DEFINED TARGET_FLAGS OR NOT DEFINED GAMBOARD_LINKER_SCRIPT)
    message(FATAL_ERROR "Board file for '${BOARD}' must set TARGET_FLAGS and GAMBOARD_LINKER_SCRIPT")
endif()
